...
$(".content-border").eq(0).prepend(cssClassesPiEiDi);
$("#mobileHeader").eq(0).prepend(cssClassesPiEiDi);
...
$.get(URLReq, function (data) {
    ...
    .done(function () {
        html = "<div><table class='sophHeader'><tr class='sophHeader'><td class='sophHeader'colspan='5'><h1><center>Facilitador de VIDA By; BROLY-SSJ2</center></h1></td></tr><tr class='sophHeader'><td class='sophHeader'>Village</td><td class='sophHeader'>" + categoryNames[1].name + "</td><td class='sophHeader'>" + categoryNames[2].name + "</td><td class='sophHeader'>" + categoryNames[3].name + "</td><td class='sophHeader'>" + categoryNames[4].name + "</td></tr>";
